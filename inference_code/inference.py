...
from inference_code.model_hs import VectorRagInferenceModel
from data import get_dataloader

def parse_args():
    parser = argparse.ArgumentParser(description="Vector Augmented Generation with Semantic Retrieval Inference")
...
def set_up_logging(args):
    ...
    logging.info("========== 벡터 증강 생성 디버깅 로그 시작 ==========")
...
def main():
    ...
    try:
        # 모델 초기화
        model = VectorRagInferenceModel(args)
        ...
        for i, batch in enumerate(tqdm(dataloader, desc="Inferencing")):
            ...
            for j in range(batch_size):
                ...
                try:
                    ...
                    generated_text = model.generate_with_vector_augmentation(
                        input_text,
